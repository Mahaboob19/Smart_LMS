// pages/AdminDashboard.jsx - Updated with blue
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Librarian Panel</p>
              </div>
            </div>
            <button
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <p className="text-gray-600">This is the administrator dashboard.</p>
      </div>
    </div>
  );
};
